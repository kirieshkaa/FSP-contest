...
function ThemeToggle({ className = '' }: { className?: string }) {
  ...
  if (!mounted) {
    return (
      <button className={`theme-toggle ${className} transition-all duration-300 hover:scale-110 active:scale-95`} aria-label="Переключить тему">
  ...
  return (
    <button
      className={`theme-toggle ${className} transition-all duration-300 hover:scale-110 active:scale-95`}
